...
namespace AnthraX.MessageBoxes {
    ...
    // ################################################################################
    public partial class CustomMessageInputBox : Form {
        ...
        //  xxxxx   x   x   xxxxx     x  
        // ######################################################################
        public CustomMessageInputBox( string title, string message, string defaultInput, Tools.MsgBoxFunction okFunc ) {
            this.Text           =   title;
